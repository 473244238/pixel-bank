...
import com.yupi.usercenter.utils.MakeToken;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     */
    @Override
    public long userRegister(String userAccount, String userPassword, String email) {
        // 1. 校验
    ...
    public User userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        String token= MakeToken.uuid();
        safetyUser.setUserPassword(token);
        // 4. 记录用户的登录态
        request.getSession().setAttribute(token, safetyUser);
        return safetyUser;
    }
